...
| Términos comerciales y reembolsos | No son necesarios mientras no haya oferta pagada, contratación ni cobro.                                                                                                                                                                                | Si se publica una página por claridad, debe decir expresamente que no hay ventas, pagos ni reembolsos aplicables; usar “Condiciones de uso” no comerciales. |
...
- La política de cookies debe nombrar al menos `_ga` y cualquier otra cookie realmente observada, su proveedor, propósito y duración. No se deben copiar listas genéricas que no coincidan con el sitio.
...
- no se necesita una política comercial de reembolsos, porque el sitio no recibe pagos ni hay suma que devolver; una página meramente informativa puede dejar este hecho claro sin inventar derechos u obligaciones;
...
- Política de cookies breve, exacta y separada o una sección claramente identificable dentro de privacidad.
...
- Condiciones de uso editoriales sólo si aportan claridad; no presentarlas como contrato de venta.
